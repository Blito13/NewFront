...
const {getMoves , payMatches ,getPlayersDb, postPlayers, setDemoPlayers, getMatches, betPercentaje ,percentajeOfNumbers, percentajeOfPlayerGamble }  = require('../controllers/javas.js');
...
router.post('/show' , percentajeOfPlayerGamble);
